  ...
  return (
    <>
      <section className={`dispatch-quick-launch-enter pointer-events-none fixed bottom-4 right-4 z-40 hidden select-none transition-all duration-300 ease-out md:block ${desktopLeftClass || (sidebarCollapsed ? 'left-24' : 'left-[19.5rem]')}`}>
        <div className="pointer-events-auto mx-auto flex h-[3.75rem] w-fit max-w-full items-center overflow-hidden rounded-md border border-cad-blue/20 bg-white/95 text-cad-ink shadow-[0_18px_48px_rgba(15,23,42,0.28)] ring-1 ring-cad-blue/10 backdrop-blur-md dark:border-blue-400/20 dark:bg-slate-950/95 dark:text-white">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`flex h-[3.75rem] w-[3.75rem] flex-col items-center justify-center gap-1 border text-[10px] font-medium transition duration-200 ease-out hover:shadow-md ${
                      visible
